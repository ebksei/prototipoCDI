...
<head>
    ...
    <script>
      ...
      function guardarDatos(){
          ...
          setCookie("casaNombre",nombre,30);
          var descripcion = document.getElementById("descripcion").value;
          setCookie("casaDescripcion",descripcion,30);
          var precio = document.getElementById("precio").value;
          setCookie("casaPrecio",precio,30);
          var suplemento = document.getElementById("suplemento").value;
          setCookie("casaSuplemento",suplemento,30);
      }
      function obtenerdatos(){
        var nombre = getCookie("casaNombre");
        if(nombre!=""){
          document.getElementById("nombre").value = nombre;
        }
        var descripcion = getCookie("casaDescripcion");
        if(descripcion!=""){
                ...
                <div class="card">
                  <div class="card-body">
                      <div class ="form-group">
                        <div class ="form-group">
                          <img class="rounded-circle img-fluid d-block mx-auto" src="images/mikasaTraining.jpg"  style="height:300px;width:300px"   alt="">
                        </div>
                        <div class="form-group">
                            <label>Nombre</label>
