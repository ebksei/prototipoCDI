                    ...
                    <div class="col-md-12">
                      <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                          <label for="nombre" class="control-label mb-1">Suplemento mañana</label>
                                          <input id="nombre" name="nombre" type="text" placeholder="€" class="form-control">
                                      </div>
                                    <div class="form-group">
                                          <label for="nombre" class="control-label mb-1">Suplemento tarde</label>
                                          <input id="nombre" name="nombre" type="text" placeholder="€" class="form-control">
                                      </div>
                                    <div class="form-group">
                                          <label for="nombre" class="control-label mb-1">Suplemento amboss</label>
                                          <input id="nombre" name="nombre" type="text" placeholder="€" class="form-control">
                                      </div>
